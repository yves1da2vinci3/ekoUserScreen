...
function ResidenceItem({field}) {
  const Navigate = useNavigate()
const residenceId = field._id

  const fieldLink ="/field/"+ residenceId
    ...
    <div className="p-6 bg-white">
      ...
      <div className="block px-6 mt-8 mb-2">
        <img
          ...
          src={field.imageUrls[0].FileLink}
      ...
      <Link 
       to={fieldLink}
             className="ml-auto mr-2 flex items-center justify-center w-12 h-12 border rounded-lg hover:border-gray-500 cursor-pointer"
